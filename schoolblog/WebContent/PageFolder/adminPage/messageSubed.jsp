...
<!DOCTYPE html PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN" "http://www.w3.org/TR/html4/loose.dtd">
			...
			<!--            文章管理--- >已发布             start       -->
			<div class="container-subed col-lg-12 col-md-12 col-sm-12" style="display:none;" >
				...
				<div class="subMenu col-lg-12 col-md-12 col-sm-12">
					<div class="createMessage">
						...
						<ul>
							<li class="draft-btn"><a onclick="addDraftbox('0')"><span class="glyphicon glyphicon-calendar" aria-hidden="true"></span> 草稿箱 </a></li>
						</ul>
					</div>
				</div>
