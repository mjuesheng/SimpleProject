...
<!--            文章管理--- >撰写文章             start       -->
			<div class="container-in col-lg-12 col-md-12 col-sm-12" style="display: none;">
				<form action="megSubServlet" method="post" onsubmit="return checkSub2()" class="form-horizontal"style="padding-top: 20px;">
					...
					<div id="editor" name="textEditor" style="width:92%;height:330px; margin:-15px 0px 0px 97px;">  
					...
					<div class="ckb">
						...
						<label>
							<select id="txtType" name="textType" class="form-control" style="width:150px;margin:10px 0px 0px 30px;">
